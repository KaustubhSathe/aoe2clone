...
int main()
{
    ...
    load_texture_from_png(std::filesystem::path("assets") / "actions_icons" / "50721_31.png", engine.buildEconomicIcon);
    load_texture_from_png(std::filesystem::path("assets") / "actions_icons" / "50721_32.png", engine.buildMilitaryIcon);
    load_texture_from_png(std::filesystem::path("assets") / "actions_icons" / "50721_29.png", engine.repairIcon);
    load_texture_from_png(std::filesystem::path("assets") / "actions_icons" / "50721_70.png", engine.garrisonIcon);
    load_texture_from_png(std::filesystem::path("assets") / "actions_icons" / "50721_04.png", engine.stopIcon);
    ...
    load_texture_from_png(std::filesystem::path("assets") / "buildings_icons" / "50705_01.png", engine.archeryRangeIcon);
    load_texture_from_png(std::filesystem::path("assets") / "buildings_icons" / "50705_24.png", engine.stableIcon);
    load_texture_from_png(std::filesystem::path("assets") / "buildings_icons" / "50705_23.png", engine.siegeWorkshopIcon);
